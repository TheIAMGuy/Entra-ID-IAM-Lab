...
| Path | Role |
|---|---|
| `docs/01-07-*` | **Primary lab walkthroughs** — the most important docs. Full, step-by-step guides the user follows in the Azure Portal to produce a verifiable result. Currently stubs — expanding these is the highest priority work. |
...
- `docs/01-07` are stubs and need to be expanded into full walkthroughs. This is priority one.
